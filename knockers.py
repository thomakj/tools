...
def brute(h, *pl):
	...
	start = 0x00  # hex literal, gives us a regular integer
	end = 0xFFFFFFFF

	for i in xrange(start, end + 1):
		print format(i, 'X')
	#k = hexlify(os.urandom(16))
		k = unhexlify("8aa87ca3b63ac5ddb7f8545046daec64")

		print hexlify(k)
		mac = h(k+m).digest()
		token = hexlify(mac + m)
		print token
		if token == "e0255f0f8141a0b572a515dfc9c62194dca2d0c6f32e3d8351d2748e41bf6f9e054698c69bb4857dfde21a7a69099d12be067a4d45d0291441b183850206fb310050":
			print hexlify(k)
			break
...
'''
		...
		load_key()
		server = KnockersServer(('localhost', PORT), KnockersRequestHandler)
